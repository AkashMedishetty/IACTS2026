                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {abstract.category && (
                            <Badge variant="outline" className="text-xs bg-amber-50/50 border-amber-200 text-amber-700">
                              {abstract.category}
                            </Badge>
                          )}
                        </div>
                  ...
                  <TabsContent value="details" className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="rounded-xl p-4 space-y-3" style={glassCardLight}>
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          <span className="text-gray-500">Presenter Category</span>
                          <p className="font-medium text-gray-900">{selectedAbstract.category || 'N/A'}</p>
                        </div>
                        <div>
