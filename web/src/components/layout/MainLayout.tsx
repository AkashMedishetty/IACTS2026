      ...
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="relative h-10 w-10 rounded-full">
          <Avatar className="h-10 w-10">
            ...
            <AvatarFallback className="bg-gradient-to-r from-[#002552] to-blue-700 text-white">
                  ...
                  <Link key={item.name} href={item.href}>
                    <Button
                      ...
                      className={`text-sm font-medium transition-all duration-200 ${isActivePage(item.href)
                        ? "bg-gradient-to-r from-[#002552] to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 shadow-md"
                        : "hover:bg-[#f0f3f8] hover:text-[#002552] dark:hover:bg-blue-900/20 dark:hover:text-blue-400"
                        }`}
                    >
              ...
              {session ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button onClick={() => { if (typeof window !== 'undefined') { window.location.assign('/register') } }}>
                    <Button className="bg-gradient-to-r from-[#002552] to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg">
                      Register Now
                    </Button>
                  </button>
                </div>
                        ...
                        <Link href={item.href} onClick={() => setIsMenuOpen(false)}>
                          <Button
                            ...
                            className={`w-full justify-start text-left h-12 transition-all duration-200 ${isActivePage(item.href)
                              ? "bg-gradient-to-r from-[#002552] to-blue-700 text-white"
                              : "hover:bg-[#f0f3f8] hover:text-[#002552] dark:hover:bg-blue-900/20 dark:hover:text-blue-400"
                              }`}
                          >
                    ...
                    <>
                      ...
                      >
                        ...
                        <button onClick={() => { setIsMenuOpen(false); if (typeof window !== 'undefined') { window.location.assign('/register') } }}>
                          <Button className="w-full bg-gradient-to-r from-[#002552] to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white h-12 shadow-lg">
