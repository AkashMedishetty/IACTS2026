...
interface Abstract {
  ...
  // Presenter category for Free Paper (Postgraduate / Junior Consultant / Fellow / Senior Consultant)
  category?: string
  authors: string[]
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                              ...
                              {abstract.category && (
                                <Badge variant="outline" className="text-xs sm:text-sm bg-amber-50 text-amber-700 border-amber-200">
                                  {abstract.category}
                                </Badge>
                              )}
