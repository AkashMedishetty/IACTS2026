...
export async function POST(
  ...
  try {
    ...
    const result = await sendEmailWithHistory({
      to: user.email,
      subject: `Welcome to ${conferenceConfig.shortName} - Registration Confirmation`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #1a365d;">Welcome to ${conferenceConfig.shortName}!</h1>
          <p>Dear ${fullName},</p>
          <p>Thank you for registering for ${conferenceConfig.shortName}. Your registration details are as follows:</p>
