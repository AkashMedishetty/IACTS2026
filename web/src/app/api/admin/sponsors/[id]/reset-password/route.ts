  ...
  try {
    ...
    if (sendEmail) {
      await sendEmailWithHistory({
        to: sponsor.email,
        subject: `${conferenceConfig.shortName} - Sponsor Portal Password Reset`,
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h1 style="color: #1a365d;">Password Reset</h1>
            <p>Dear ${sponsor.sponsorProfile?.contactPerson},</p>
            <p>Your password for the ${conferenceConfig.shortName} Sponsor Portal has been reset.</p>
        ...
        `,
        text: `Your ${conferenceConfig.shortName} Sponsor Portal password has been reset.\n\nEmail: ${sponsor.email}\nNew Password: ${plainPassword}\n\nLogin at: ${process.env.NEXTAUTH_URL}/sponsor/login`,
        userId: sponsor._id,
