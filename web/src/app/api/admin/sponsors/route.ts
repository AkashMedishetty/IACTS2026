...
export async function POST(request: NextRequest) {
  try {
    ...
    await sendEmailWithHistory({
      to: email,
      subject: `Welcome to ${conferenceConfig.shortName} - Sponsor Portal Access`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #1a365d;">Welcome to ${conferenceConfig.shortName} Sponsor Portal</h1>
