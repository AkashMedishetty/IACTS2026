...
export async function GET() {
  try {
    ...
    const abstractsWithReviews = abstracts.map(abstract => {
      ...
      // Map to expected format with new the conference fields
      return {
        _id: abstract._id,
        ...
        category: abstract.category, // presenter category (Postgraduate / Junior Consultant / Fellow / Senior Consultant)
